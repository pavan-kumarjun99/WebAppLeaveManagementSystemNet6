...
namespace WebAppLeaveManagementSystem.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            ReturnUrl = returnUrl; //keep the return URL 
            ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
        }

        public async Task<IActionResult> OnPostAsync(string returnUrl = null) //submission of the form
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.DateOfJoining = Input.DateOfJoining;
